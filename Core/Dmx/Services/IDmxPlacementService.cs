...
{
    /// <summary>
    /// Revit-free contract for placing a solved system's decoders + drivers. Implemented
    ...
    public interface IDmxPlacementService
    {
        ...
        /// <param name="locked">Lock state — gates orphan removal: auto when Unlocked, confirmed when Locked.</param>
